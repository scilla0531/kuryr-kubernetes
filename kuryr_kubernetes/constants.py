...
K8S_ANNOTATION_SUBNET_ID = 'subnetId'
K8S_ANNOTATION_ROUTER_ID = 'routerId'
K8S_ANNOTATION_SG_ID = 'sgId'
K8S_ANNOTATION_FIXED_IP = 'fixedIP'
# K8S_ANNOTATION_FIXED_IP = K8S_ANNOTATION_PREFIX + '-pod-fixed-ip'
K8S_ANNOTATION_HEADLESS_SERVICE = 'service.kubernetes.io/headless'
K8S_KNS_PROJECT_ID = 'projectId'
K8S_KNS_SVC_SUBNET_ID = 'svcSubnetId'
K8S_KNS_SUBNET_ID = 'subnetId'
K8S_KNS_NETWORK_ID = 'networkId'
K8S_KNS_ROUTER_ID = 'routerId'
